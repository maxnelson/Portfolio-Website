...
export const resumeItemPropObjectChico: resumeItemType = {
  ...
  id: "Chico",
  description1:
    "Studied many mediums of Graphic Design, including Information Design, Typography, Branding, and User Interface Design, with an upper-division theme in computer programming.",
};
