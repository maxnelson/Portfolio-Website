						...
						<View style={styles.multipage_container}>
							...
							<View>
								<ResumeItem
									...
									startDateMonth={
										props.resumeData?.section1.datafinitygroup.startDateMonth
									}
									endDateMonth={
									...
									/*
									technologies_used={
										props.resumeData?.section1.datafinitygroup.technologies_used
									}
									*/
								/>
								<ResumeItem
								...
								<ResumeItem
									...
									/*
									technologies_used={
										props.resumeData?.section1.aquent.technologies_used
									}
									*/
								/>
								<ResumeItem
								...
								<ResumeItem
									...
									/*
									technologies_used={
										props.resumeData?.section1.apple2.technologies_used
									}
									*/
								/>
								...
								<ResumeItem
									...
									description11={
										props.resumeData?.section1.cloudera.description11
									}
									/*
									technologies_used={
								...
								<ResumeItem
									...
									/*
									technologies_used={
										props.resumeData?.section1.levis.technologies_used
									}
									*/
								/>
								<ResumeItem
									...
									/*
									technologies_used={
										props.resumeData?.section1.numi.technologies_used
									}
									*/
								/>
								<ResumeItem
									customStyle={styles.margin_bottom_5}
									clientName={
										props.resumeData?.section1.stringLetterPublishing.clientName
									}
									jobTitle={
										props.resumeData?.section1.stringLetterPublishing.jobTitle
									}
									startDateMonth={
										props.resumeData?.section1.stringLetterPublishing
											.startDateMonth
									}
									endDateMonth={
										props.resumeData?.section1.stringLetterPublishing
								...
								<ResumeItem
									...
									endDateMonth={
										props.resumeData?.section1.truckerDeluxe.endDateMonth
									}
									startDateYear={
										props.resumeData?.section1.truckerDeluxe.startDateYear
									}
									endDateYear={
										props.resumeData?.section1.truckerDeluxe.endDateYear
									}
									description1={
										props.resumeData?.section1.truckerDeluxe.description1
									}
									/*
									technologies_used={
										props.resumeData?.section1.truckerDeluxe.technologies_used
									}
									*/
								/>
								<ResumeFooter
									...
									description={
										props.resumeData?.section2.education.longDescription
									}
