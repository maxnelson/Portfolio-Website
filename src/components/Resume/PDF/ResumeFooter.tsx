  ...
  return (
    <View style={[styles.flex_direction_row]}>
      <View style={[styles.width_45_percent, styles.margin_right_5_percent]}>
        <ResumeSectionHeader title={props.educationTitle} customStyle={[styles.margin_bottom_5]} />
        <EducationSection degree={props.degree} school={props.school} startDateYear={props.startDateYear} endDateYear={props.endDateYear} description={props.description} />
      </View>
      <View style={styles.width_50_percent}>
        <ResumeSectionHeader title={props.skillsTitle} customStyle={[styles.margin_bottom_5]} />
        <SkillsSection
          ...
          skill4Description={props.skill4Description}
          skill5Description={props.skill5Description}
          skill6Description={props.skill6Description}
          skill7Description={props.skill7Description}
        />
      </View>
    </View>
  );
