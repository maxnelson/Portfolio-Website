          ...
          <Page size="LETTER">
            <View style={styles.page_container}>
              <View style={styles.lineHeight}>
                <ResumeHeader name={props.resumeData?.name.toUpperCase()} title={props.resumeData?.title} email={props.resumeData?.contactInfo.email} phone={props.resumeData?.contactInfo.phone} website={props.resumeData?.contactInfo.website} />
                <SummarySection summary1={props.resumeData?.summary1} summary2={props.resumeData?.summary2} />
                <ResumeSectionHeader title={props.resumeData?.section1.title} customStyle={[styles.margin_bottom_5]} />
                <View>
                  <ResumeItem
                  ...
                  <ResumeItem
                    ...
                    startDateMonth={props.resumeData?.section1.rubrik.startDateMonth}
                  ...
                  <ResumeItem
                    ...
                    startDateMonth={props.resumeData?.section1.cloudera.startDateMonth}
                    endDateMonth={props.resumeData?.section1.cloudera.endDateMonth}
                    startDateYear={props.resumeData?.section1.cloudera.startDateYear}
                  ...
                  <ResumeFooter
                    ...
                    startDateYear={props.resumeData?.section2.education.startDateYear}
                    ...
                    skill7Title={props.resumeData?.section2.skills.skill7.title}
                    skill1Description={props.resumeData?.section2.skills.skill1.description}
                    skill2Description={props.resumeData?.section2.skills.skill2.description}
                    skill3Description={props.resumeData?.section2.skills.skill3.description}
                    skill4Description={props.resumeData?.section2.skills.skill4.description}
                    skill5Description={props.resumeData?.section2.skills.skill5.description}
