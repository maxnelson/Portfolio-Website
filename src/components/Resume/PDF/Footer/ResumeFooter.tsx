...
import { SkillsSection } from "@src/components/Resume/PDF/Footer/SkillsSection";
import { EducationSection } from "@src/components/Resume/PDF/Footer/EducationSection";
		...
		<View style={[styles.flex_direction_row]}>
			<View style={[styles.width_45_percent, styles.margin_right_5_percent]}>
				<ResumeSectionHeader
					...
					customStyle={[styles.margin_bottom_0]}
				/>
				<EducationSection
					degree={props.degree}
					school={props.school}
