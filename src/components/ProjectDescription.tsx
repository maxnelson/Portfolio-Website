  ...
  return (
    <div className="project_description_container">
      <div className="project_description_container_images">
        {projectData?.image1 ? <img src={projectData?.image1}></img> : null}
        {projectData?.image2 ? <img src={projectData?.image2}></img> : null}
        {projectData?.image3 ? <img src={projectData?.image3}></img> : null}
        {projectData?.image4 ? <img src={projectData?.image4}></img> : null}
      </div>
      <div className="project_description_text_container _word-wrap--break-word">
        {projectData?.clientName && (
          <div className="_margin-bottom--1rem">
            ...
            <span>{(projectData?.startDateYear ? projectData?.startDateMonth + " " + projectData?.startDateYear : "") + (projectData?.endDateYear ? " - " + projectData?.endDateMonth + " " + projectData?.endDateYear : "")}</span>
          </div>
        )}
        <div
