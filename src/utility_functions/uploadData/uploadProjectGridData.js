...
export const uploadProjectGridData = async () => {
  const timelineDescription = readFileSync("src/content/projectDescriptionsHTML/timelineDescription.html", "utf-8");
  const appleDescription = readFileSync("src/content/projectDescriptionsHTML/appleDescription.html", "utf-8");
  const rubrikDescription = readFileSync("src/content/projectDescriptionsHTML/rubrikDescription.html", "utf-8");
  const clouderaDescription = readFileSync("src/content/projectDescriptionsHTML/clouderaDescription.html", "utf-8");
  const gifhovDescription = readFileSync("src/content/projectDescriptionsHTML/gifhovDescription.html", "utf-8");
  const blogDescription = readFileSync("src/content/projectDescriptionsHTML/blogDescription.html", "utf-8");
