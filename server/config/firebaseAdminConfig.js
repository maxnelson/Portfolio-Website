...
const decodedCredentials = JSON.parse(Buffer.from(base64Credentials, "base64").toString("utf8"));
...
export const firestore_database_service_account = admin.default.firestore();
